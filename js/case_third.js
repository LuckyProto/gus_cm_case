...
// $.ajax({
//     type: "POST",
//     url: "http://127.0.0.1/guservice/getEmrValue",
//     contentType : "application/x-www-form-urlencoded",
//     dataType: 'json',
//     data: {
//         id: 198
...
function createCase (value2, index2, array2, xxlis, $xx) {
    switch (true){
                ...
                switch (true){
                    ...
                    case value3.options.length != 0:
                        if(value3.itemTypeId == 4){
                            ...
                            //     var $inputCheckbox = $("<input type='checkbox'>").attr({optionid: value4.optionId, itemId: value3.itemId});
                            //     if($inputCheckbox.attr('optionid') == value3.itemValue){
                            //         $inputCheckbox.attr({'checked': 'checked'})
                            //     }
                            //     $inputCheckbox.prependTo($label);
                            //     $label.appendTo($form);
                            // })
                            // $form.appendTo($li3)
                    ...
                    case value3.options.length == 0 && value3.childNodes.length == 0:
                        switch (true){
                            case value3.itemTypeId == 2:
                                ...
                                // var $li3 = $("<li>");
                                // var $p = $("<p>").text(value3.itemName);
                                // $p.prependTo($li3);
                                // $li3.appendTo($ul);
                                // var $textarea = $("<textarea type='textarea'>").val(value3.itemValue == null ? "": value3.itemValue).attr({itemid: value3.itemId, parentid: value3.parentId});
                            ...
                            case value3.itemTypeId == 10:
                                ...
                                if(value3.value){
                                    var $btn_checkImg = $('<a href="javascript:void(0)" onclick="toImgcheck($(this))">').text('查看大图').attr({'itemid': value3.itemId, 'value': value3.value}).css({'margin-left': '30%', 'margin-right': '4%'});
        ...
        case value2.options.length > 0:
            ...
            // if(value2.option_value == 44){
            //     var $ul = $("<ul>");
            //     $ul.appendTo($xx);
            //
            //     var $form = $("<form>");
            //     $form.appendTo(xxlis[index2]);
            //     var randomNum = Math.random() * 1000000000000000000;
            //     var value_inputName = "value_inputName" + randomNum;
            //     //是选项
            //     var numYse = Math.random() * 10;
            //     var $inputYse = $('<input type="radio">').attr({'id': numYse, 'name':value_inputName, 'itemId': value2.itemId, 'parentId': value2.parentId, 'optionId': value2.options[0].optionId, 'checked': true}).val(value2.options[0].optionName);
            //     var $labelYes = $('<label>').attr({'for': numYse}).text(value2.options[0].optionName);
            //     $inputYse.prependTo($labelYes);
            //     $labelYes.appendTo($form);
            //     //否选项
            //     var numNo = Math.random() * 10;
            //     var $inputNo = $('<input type="radio">').attr({'id': numNo, 'name':value_inputName,   'itemId': value2.itemId, 'parentId': value2.parentId, 'optionId': value2.options[1].optionId}).val(value2.options[1].optionName);
            //     var $labelNo = $('<label>').attr({'for': numNo}).text(value2.options[1].optionName);
            //     $inputNo.prependTo($labelNo);
            //     $labelNo.appendTo($form);
            //
            //     //不知道选项
            //     var numUn = Math.random() * 10;
            //     var $inputUn = $('<input type="radio">').attr({'id': numUn, 'name':value_inputName,   'itemId': value2.itemId, 'parentId': value2.parentId, 'optionId': value2.options[2].optionId}).val(value2.options[2].optionName);
            //     var $labelUn = $('<label>').attr({'for': numUn}).text(value2.options[2].optionName);
            //     $inputUn.prependTo($labelUn);
            //     $labelUn.appendTo($form);
            // }else if(value2.option_value == 45){
            //     var $ul = $("<ul>");
            //     $ul.appendTo($xx);
            //
            //     var $form = $("<form>");
            ...
            //     //是选项
            //     var numYse = Math.random() * 10;
            //     var $inputYse = $('<input type="radio">').attr({'id': numYse, 'name':value_inputName, 'itemId': value2.itemId, 'parentId': value2.parentId, 'optionId': value2.options[0].optionId}).val(value2.options[0].optionName);
            //     var $labelYes = $('<label>').attr({'for': numYse}).text(value2.options[0].optionName);
            //     $inputYse.prependTo($labelYes);
            //     $labelYes.appendTo($form);
            //     //否选项
            //     var numNo = Math.random() * 10;
            //     var $inputNo = $('<input type="radio">').attr({'id': numNo, 'name':value_inputName, 'checked': true, 'itemId': value2.itemId, 'parentId': value2.parentId, 'optionId': value2.options[1].optionId}).val(value2.options[1].optionName);
            //     var $labelNo = $('<label>').attr({'for': numNo}).text(value2.options[1].optionName);
            //     $inputNo.prependTo($labelNo);
            //     $labelNo.appendTo($form);
            //
            ...
            //     $inputUn.prependTo($labelUn);
            //     $labelUn.appendTo($form);
            // }else if(value2.option_value == 61){
            //     var $ul = $("<ul>");
            //     $ul.appendTo($xx);
            //
            //     var $form = $("<form>");
            ...
            //     //不知道选项
            //     var numUn = Math.random() * 10;
            //     var $inputUn = $('<input type="radio">').attr({'id': numUn, 'name':value_inputName, 'checked': true, 'itemId': value2.itemId, 'parentId': value2.parentId, 'optionId': value2.options[2].optionId}).val(value2.options[2].optionName);
            //     var $labelUn = $('<label>').attr({'for': numUn}).text(value2.options[2].optionName);
            //     $inputUn.prependTo($labelUn);
            //     $labelUn.appendTo($form);
            // }else{
        ...
        default:
            switch (true){
                ...
                case value2.itemTypeId == 8:
                    ...
                    //
                    // var $p = $("<p>");
                    // var $input = $("<input type='text'>").val(value2.itemValue).attr({itemid: value2.itemId});
                    // $input.appendTo($p);
...
/*lev2左侧单选按钮组点击选中与不选中*/
$("#beforeCaseTitleUl>li, #nowCase>ul>li").delegate('input', 'click', function () {
...
$('#beforeCaseBtn, #nowCaseBtn, #physicaSignBtn, #laboratoryBtn, #assistCheckBtn').click(function () {
    ...
    $('*').each(function () {
        ...
        if($(this).attr('type') == 'radio'){
            ...
            if($(this).attr('checked') == 'checked'){
                caseItem.itemId   = $(this).attr('itemid');
                // caseItem.parentid   = $(this).attr('parentid');
                caseItem.itemValue   = $(this).attr('optionId');
                // caseItem.value_inputCheckbox = $(this).text();
...
function unique(array){
    ...
    for(var i = 1; i < array.length; i++){
        if(re[re.length-1].itemId !== array[i].itemId){
            ...
            re[re.length-1].value = re[re.length-1].value.concat(array[i].value);
            var imgs = re[re.length-1].value.sort();
            ...
            re[re.length-1].value = unique_imgs;
        }
    }
    return re;
}
